...
class WC_Report_Carts_By_Date extends WC_Admin_Report {
	...
	public function get_chart_legend() {
		...
		$legend[] = array(
			'title' => sprintf(
				__( '%s abandoned carts in this period.', 'wc-cart-reports' ),
		...
		$legend[] = array(
			'title' => sprintf(
				__( '%s orders placed', 'wc-cart-reports' ),
		...
		<script type="text/javascript">
			...
			jQuery( function () {
				...
				var drawGraph = function ( highlight ) {
					var series = [
						{
							label: "<?php echo esc_js( __( 'Number of conversions', 'wc-cart-reports' ) ); ?>",
							...
							label: "<?php echo esc_js( __( 'Abandoned Carts', 'wc-cart-reports' ) ); ?>",
