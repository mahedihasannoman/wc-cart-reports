...
class WC_Report_Carts_By_Product extends WC_Admin_Report {
	...
	public function get_chart_legend() {
		...
		$legend[]    = array(
			'title'            => sprintf(
				__( '%s Product Abandonments', 'wc-cart-reports' ),
	...
	public function output_report() {
		...
		$ranges = array(
			'year'       => __( 'Year', 'wc-cart-reports' ),
			'last_month' => __( 'Last Month', 'wc-cart-reports' ),
			'month'      => __( 'This Month', 'wc-cart-reports' ),
			'7day'       => __( 'Last 7 Days', 'wc-cart-reports' ),
		);
	...
	public function get_chart_widgets() {
		...
		if ( ! empty( $this->product_ids ) ) {
			$widgets[] = array(
				'title'    => __( 'Showing reports for:', 'wc-cart-reports' ),
	...
	public function products_widget() {
		...
		?>
		<h4 class="section_title"><span><?php esc_attr_e( 'Product Search', 'wc-cart-reports' ); ?></span></h4>
		<div class="section">
			<form method="GET">
				<div>
	...
	public function get_export_button() {
		...
		<a
			...
			class="export_csv"
			data-export="chart"
			data-xaxes="<?php _e( 'Date', 'wc-cart-reports' ); ?>"
			data-groupby="<?php echo $this->chart_groupby; ?>"
		>
			<?php _e( 'Export CSV', 'wc-cart-reports' ); ?>
		</a>
		<?php
	}
	...
	public function get_main_chart() {
		...
		";
			...
			$label       = __( 'Number of items Abandoned', 'wc-cart-reports' );
			?>
			<div class="chart-container">
